...
<body>
	...
	<div class="contact-from-section mt-80 mb-150">
		<div class="container">
			...
			<form action="dogInfoAddRegist" method="post" enctype="multipart/form-data" onSubmit="return dogJoinCheck(this)">
			<div class="row">
				...
				<div class="col-lg-6 mb-5 mb-lg-0">
					...
					<div class="contact-form">
								<input type="hidden" id="dog_owner" value="${sessionScope.loginId }" name="dog_owner">
			...
			<div class="row">
				...
				<div class="col-lg-4 mb-5 mb-lg-0">
					<input type="button" id="skipBtn" value="취 소">
				</div>
			</div>
			</form>
		</div>
	...
	<script type="text/javascript">
		...
		$(document).ready(function(){
			...
			$("#skipBtn").click(function(){
				Swal.fire({
					  title: '반려견 등록을 취소하시겠습니까?',
					  text: '최초 반려견 미등록 시 활동 제약을 받습니다.',
					  icon: 'warning',
					  showCancelButton: true,
					  confirmButtonText: '마 이 페 이 지 로',
		...
		function dogJoinCheck(form){
			...
			Swal.fire({
				  ...
				  cancelButtonText: '마 이 페 이 지 로'
					...
					{
						form.action = "dogInfoAddRegistEnd";
						form.submit();
						return true;
					}
				});
