				...
				success : function(result){
					...
					for (var i = 0; i < result.length; i++){
						...
						output += "<div id =\"commentList" + i + "\"class=\"single-comment-body\">"+ "<div class=\"comment-user-avater\">"+ "<input type = \"hidden\" value = \"" + result[i].recomment_state + "\">"
								+ "<img src=\"${pageContext.request.contextPath }/resources/fileUpload/"+result[i].recomment_profile+"\">"+ "</div>"+ "<div class=\"comment-text-body\">"+
								"<input type = \"hidden\" value = \""+result[i].recomment_code+"\">"+
								"<input type = \"hidden\" value = \""+result[i].recomment_boardcode+"\">"+
								"<h4>"+result[i].recomment_writer+" <span class=\"comment-date\">"+result[i].recomment_date +"</span> <a onclick=\"tipsCommentReport('"+result[i].recomment_boardcode+"','"+result[i].recomment_code+"','"+'${sessionScope.loginId}'+"')\"><img src=\"https://cdn.discordapp.com/attachments/992004476040904815/996374088283082762/siren.png\" style = \"width: 15px; margin-bottom: 9px; text-decoration: none; border-bottom: 0px;\"> 신고</a></h4>"+
