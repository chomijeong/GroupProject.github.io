...
<body>
	...
	<div class="checkout-section mt-150" style="margin-bottom: 50px;">
		<div class="container">
			<form action="tipsViewModify" method="post" id="formbtn">
				<div class="row">
								...
								<div class="billing-address-form">
									<div class="form-group row">
										<div class="col-12">
											...
											<input type="text" class="form-control form-control-user" name="board_title" value="${tips.board_title }">
											<input type="hidden" class="form-control form-control-user" name="board_code" value="${tips.board_code }">
											<input type="hidden" class="form-control form-control-user" name="board_writer" value="${tips.board_writer }">
										</div>
									</div>
									...
									<div class="form-group row">
										<div class="col-sm-12 mb-3 mb-sm-0">
											<p>
												<textarea class="form-control" name="board_content" id="editor" style="width: 100%; height: 500px;">${tips.board_content }</textarea>
											</p>
										</div>
									</div>
										...
										<div class="col-sm-4 mb-3 mb-sm-0">
											<div class="form-group row">
												<div class="col-sm-6 mb-3 mb-sm-0">
													<button onclick="modifyCheck()" style="width: 100%">저장</button>
												</div>
												<div class="col-sm-6 mb-3 mb-sm-0">
													<button type="button" onclick="tipsModifyCancel('${tips.board_code }', '${tips.board_writer }')" style="width: 100%">취소</button>
												</div>
											</div>
										</div>
									</div>
	...
	<script type="text/javascript">
		...
		function tipsModifyCancel(board_code, loginId) {
			console.log("글수정 취소 버튼")
			...
			Swal.fire({
	  			   ...
	  			   if (result.isConfirmed) { // 만약 모달창에서 confirm 버튼을 눌렀다면
	  				 location.href = "${pageContext.request.contextPath}/tipsViewPage?board_code=" + board_code + "&loginId=" + loginId ;
