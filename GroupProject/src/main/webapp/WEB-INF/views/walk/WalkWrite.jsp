...
<body>
							...
							<div class="card-body">
								<div class="billing-address-form">
						        	...
						        	<p id = "people">
										...
										class="inputbtnOff inputbtnOffAdd" onclick="inputbtnSTtoggle2(this)">2명</a><a style="border-radius:0px" 
										class="inputbtnOff inputbtnOffAdd" onclick="inputbtnSTtoggle2(this)">3명</a><a style="border-radius:0px" 
										class="inputbtnOff inputbtnOffAdd" onclick="inputbtnSTtoggle2(this)">4명</a><a style="border-radius:0px 3px 3px 0px;"
										class="inputbtnOff inputbtnOffAdd" onclick="inputbtnSTtoggle2(this)">5명</a>
									</p>
						        	<p>
						        		<div class="row">
						        			<div class= "col">
	...
	<div style="display:none">
		<form id ="finalForm" action="walkWrite" method="POST">
...
//초기화면에서 바로 회원의 정보중 주소의 시/군구 내용으로 검색을 합니다.
	...
	beforeInputaddr = memberAddress.split(" ")[0]+" "+memberAddress.split(" ")[1]
...
function sendFormData(){
	...
	//출발주소체크 최종주소를 " " 로 나눴을때 입력값이 없다면 3, 있다면 4이상 입니다. 
	if(formStartAddr.split(" ").length<4){		
		finalcheck = false;
		Swal.fire("주소를 검색해주세요");
		return null;
	}
	//지도좌표정보체크
	if(row.length<2){
