...
<body>
	...
	<div class="checkout-section mt-150" style="margin-bottom:50px;">
		<div class="container">
			<form action="reviewWrite" method = "get" id="formbtn" onSubmit="return checkContent()">
			<div class="row">
						...
						<div class="card-header text-center" >
						 ...
						 <div class="card-body mb-10">
						     ...
						     <input type="hidden" class="form-control form-control-user" id="walk_map" name = "walk_map"
                                            value = '${walkinfo.walk_map }'>
                                            
                              <input type="hidden" class="form-control form-control-user" id="walk_people" name = "walk_people"
                                            value = "${walkinfo.walk_people }">
                                                                                                      
                                      <input type="hidden" class="form-control form-control-user" id="walk_file" name = "walk_file"
                                            value = "${walkinfo.walk_code }">   
						     ...
						     <div class="form-group row">
						        ...
						        <div class="col-sm-6 mb-3 mb-sm-0">
                                        ...
                                        <input type="text" class="form-control form-control-user" id="walk_date" name = "walk_date"
                                            value = "${walkinfo.walk_date }" readonly="readonly" style="pointer-events: none;">
						      ...
						      <div class="form-group row">
                           		    ...
                           		    <div class="col-sm-6 mb-3 mb-sm-0">
                                        ...
                                        <input type="text" class="form-control form-control-user" id="walk_startaddr" name = "walk_startaddr"
                                             value = "${walkinfo.walk_startaddr }" readonly="readonly" style="pointer-events: none;">
                                    </div>
                                  ...
                                  <div class="col-sm-6">
                                        ...
                                        <input type="text" class="form-control form-control-user" name ="walk_mid" id = "walk_mid"
                                            placeholder="모집인원"  value = "${walkinfo.walk_mid }" readonly="readonly" style="pointer-events: none;">
                                    </div>
                                ...
                                <div class="form-group row">
                           		    ...
                           		    <div class="col-sm-6 mb-3 mb-sm-0">
                                        ...
                                        <input type="text" class="form-control form-control-user" id="walk_weatherinfo" name = "walk_weatherinfo"
                                             value = "${walkinfo.walk_weatherinfo }" readonly="readonly" style="pointer-events: none;">
                                    </div>
                                  ...
                                  <div class="col-sm-6">
                                        ...
                                        <input type="text" class="form-control form-control-user" name ="walk_writer" id="walk_writer"
                                            placeholder="작성자" value = "${sessionScope.loginId }" readonly="readonly" style="pointer-events: none;">
                                    </div>
                                     ...
                                     <div class="form-group row">
                           		    ...
                           		    <div class="col-sm-6 mb-3 mb-sm-0">
                                        ...
                                        <input type="text" class="form-control form-control-user" id="walk_time" name = "walk_time"
                                            value = "${walkinfo.walk_time }" readonly="readonly" style="pointer-events: none;">
                                    </div>
                              	...
                              	<label class = "text-center">강 아 지 체 형</label>
                                        <input type="text" class="form-control form-control-user" id="walk_bodytype" name = "walk_bodytype"
                                              value = "${walkinfo.walk_bodytype }" readonly="readonly" style="pointer-events: none;">
                                    </div>
						     	...
						     	<div class="form-group row">	
						        	...
						        	<p><textarea class="form-control" name="walk_content" id="editor" style="width: 100%; height:500px;">내 용 입 력 창</textarea></p>		
						        			</div>		            
						         </div>
