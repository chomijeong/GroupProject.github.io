...
<body>
							...
							<div class="card-body">
								<div class="billing-address-form">
						        	...
						        	<p id = "people">
										...
										class="inputbtnOff inputbtnOff" id="people3" onclick="inputbtnSTtoggle2(this)">3명</a><a style="border-radius:0px" 
										class="inputbtnOff inputbtnOff" id="people6" onclick="inputbtnSTtoggle2(this)">6명</a><a style="border-radius:0px" 
										class="inputbtnOff inputbtnOff" id="people14" onclick="inputbtnSTtoggle2(this)">14명</a><a style="border-radius:0px 3px 3px 0px;"
										class="inputbtnOff inputbtnOff" id="people20" onclick="inputbtnSTtoggle2(this)">20명</a>
									</p>
						        	<p>
						        		<div class="row">
						        			<div class= "col">
						        				<a id="dogS" class="ibtnOff" style="width:100%">10kg미만<br>소형견</a>
						        			</div>
						        			<div class= "col">
						        				<a id="dogM" class="ibtnOff" style="width:100%" >10kg~25kg<br>중형견</a>
						        			</div>
						        			<div class= "col">
						        				<a id="dogL" class="ibtnOff" style="width:100%">25kg초과<br>대형견</a>
						        			</div>
										</div>
									</p>
									<p>
	...
	<div style="display:none">
		<form id ="finalForm" action="crewWalkViewModify" method="POST">
			<!-- 산책글코드 -->
...
if(dogrow[0] !="----"){
	$("#dogS").toggleClass("ibtnOff").toggleClass("ibtn");
}if(dogrow[1] !="----"){
	$("#dogM").toggleClass("ibtnOff").toggleClass("ibtn");
}if(dogrow[2] !="----"){
	$("#dogL").toggleClass("ibtnOff").toggleClass("ibtn");
}
...
//근본주소 제일 상위 지역을 저장합니다.
var beforeInputaddr=firststartAddr.split(" ")[1];
...
var memberHaveDogWeight = '${walkBoardInfo.walk_bodytype}';
