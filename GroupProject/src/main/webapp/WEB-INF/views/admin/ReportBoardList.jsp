				...
				<table class="table table-layout: fixed" id="table" width="100%" data-pagination="true" data-page-number="1" data-toggle="table"
					...
					<thead class="table-dark">
						<tr class="text-center">
							...
							<th width="5%" data-field="total_code" data-filter-control="input" data-sortable="true">게시 번호</th>
							...
							<th width="5%" data-field="total_hits" data-filter-control="input" data-sortable="true">조회수</th>
							<th width="7%" data-field="total_check" data-filter-control="input" data-sortable="false">처리</th>
						</tr>
					</thead>
						...
						<c:forEach items="${totalBoard_reportList}" var="report">
							<tr class="text-left">
								<c:set var="codenumber" value="${fn:substring(report.total_code,2,6)}" /><!-- 코드 숫자만 -->
									...
									<td>
								<button class=boxed-btn onclick="RestoreReportBoard('${report.total_code}')">글활성화</button>
